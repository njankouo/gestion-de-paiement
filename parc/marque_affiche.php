...
<div class="dropdown">
  <button class="dropbtn">gestion marque</button>
  <div class="dropdown-content">
    <a href="marque.php">nouveau</a>
    ...
    <a href="parc.php">liste des fournisseurs</a>
	   ...
	   <table id="tab" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    <th class="th-sm">#<span class="glyphicon glyphicon-sort-by-attributes-alt"></span>
                      ...
                      <th class="th-sm">nom de la marque&nbsp;<span class="glyphicon glyphicon-sort"></span>
                       </th>
                        <th class="th-sm">durabilite de la marque&nbsp;<span class="glyphicon glyphicon-sort"></span>
                         </th>
                          
                        <th class="th-sm">concepteur de la marque&nbsp;<span class="glyphicon glyphicon-sort"></span>
                         </th>
		...
		<?php
			...
			?>
			<tr class="element">
				<td class="data"><?php echo $marque->id ?></td>
				<td class="data"><?php echo $marque->nom?></td>
				<td class="data"><?php echo $marque->durabilite ?></td>
				<td class="data"><?php echo $marque->constructeur ?></td>
				

				<td>
					<a href="<?php echo 'controller/marqueController.php?action=read&id=' . $marque->id ?>">
	  <button type="button" class="btn btn-success bt"name="modifier">modifier</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

					</a>
				
					<a href="<?php echo 'controller/marqueController.php?action=delete&id=' . $marque->id ?>">
