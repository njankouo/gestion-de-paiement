...
$interventions = $interventiondb->readAll();
	...
	<div class="row">
		<div class="col-md-12"><br>
		 <nav class="navbar navbar-expand-lg navbar-light col-md-12 color">
             ...
             <p class="text-light">liste des interventions</p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <a href="parc.php">liste des fournisseurs</a>
	   ...
	   <table id="tab" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    <th class="th-sm">#<span class="glyphicon glyphicon-sort-by-attributes-alt"></span>
                      ...
                      <th class="th-sm">date des interventions&nbsp;<span class="glyphicon glyphicon-sort"></span>
                       </th>
                        <th class="th-sm">accomplissement&nbsp;<span class="glyphicon glyphicon-sort"></span>
                         </th>
                          
                        <th class="th-sm">observation&nbsp;<span class="glyphicon glyphicon-sort"></span>
                         </th>
                        <th class="th-sm">description panne&nbsp;<span class="glyphicon glyphicon-sort"></span>
                         </th>
		...
		<?php
			...
			?>
			<tr class="element">
				<td class="data"><?php echo $intervention->id ?></td>
				<td class="data"><?php echo $intervention->date?></td>
				<td class="data"><?php echo $intervention->accomplie ?></td>
				<td class="data"><?php echo $intervention->observation?></td>
				<td class="data"><?php echo $intervention->description_panne ?></td>
		

				<td>
					<a href="<?php echo 'controller/interventionController.php?action=read&id=' . $intervention->id ?>">
	  <button type="button" class="btn btn-success bt"name="modifier">modifier</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

					</a>
				
					<a href="<?php echo 'controller/interventionController.php?action=delete&id=' . $intervention->id ?>">
