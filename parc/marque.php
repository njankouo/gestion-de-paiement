...
<div class="col-md-9"><br><br><br><br><br><br>
  <div class="row">
           ...
           <div class="col-md-6">
           <form name="form" action="controller/marqueController.php?action=create" method="POST" form="inline_group">
    
  

    <label for="marque">marque</label>
    <input type="marque" class="form-control" name="nom" id="formGroupExampleInput" placeholder="entrez la marque"required> 
    
 

     </div> 
     <div class="col-md-6"> 
      <label for="concepteur">nom du concepteur</label>
    <input type="text" class="form-control" name="constructeur" id="formGroupExampleInput" placeholder="entrez le nom du concepteur"required>
     
    </div>   <br> 
    
     <div class="col-md-12"> <br>
      <label for="marque"> annee durabilite de la marque</label>

    <input type="text" class="form-control" name="durabilite" id="formGroupExampleInput" placeholder="entrez la durabilite de la marque "required>
