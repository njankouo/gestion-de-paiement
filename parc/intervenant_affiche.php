...
$intervenants = $intervenantdb->readAll();
	...
	<div class="row">
		<div class="col-md-12"><br>
		 <nav class="navbar navbar-expand-lg navbar-light col-md-12 color">
             ...
             <p class="text-light">liste des intervenants</p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	   ...
	   <table id="tab" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    <th class="th-sm">#<span class="glyphicon glyphicon-sort-by-attributes-alt"></span>
                      ...
                      <th class="th-sm">nom&nbsp;<span class="glyphicon glyphicon-sort"></span>
                        ...
                        <th class="th-sm">telephone&nbsp;<span class="glyphicon glyphicon-sort"></span>
                         </th>
                        <th class="th-sm">type d'intervention&nbsp;<span class="glyphicon glyphicon-sort"></span>
                         </th>
		...
		<?php
			...
			?>
			<tr class="element">
				<td class="data"><?php echo $intervenant->id ?></td>
				<td class="data"><?php echo $intervenant->nom?></td>
				<td class="data"><?php echo $intervenant->prenom ?></td>
				<td class="data"><?php echo $intervenant->telephone ?></td>
				<td class="data"><?php echo $intervenant->type_intervention ?></td>
				

				<td>
					<a href="<?php echo 'controller/intervenantController.php?action=read&id=' . $intervenant->id ?>">
	  <button type="button" class="btn btn-success bt"name="modifier">modifier</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

					</a>
				
					<a href="<?php echo 'controller/intervenantController.php?action=delete&id=' . $intervenant->id ?>">
