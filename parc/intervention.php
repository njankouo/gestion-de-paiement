...
<div class="container-fluid">
    ...
    <nav class="navbar navbar-expand-lg navbar-light col-md-12 color">
             ...
             <p class="text-light">formulaire D'ajout des interventions</p>
...
<div class="col-md-9"><br><br><br><br><br><br>
  <div class="row">
           ...
           <div class="col-md-6">
           <form name="form" action="controller/interventionController.php?action=create" method="POST" form="inline_group">
    
  

    <label for="date">date intervention</label>
    <input type="date" class="form-control" name="date" id="formGroupExampleInput" placeholder="date de l'intervention"required> 
    ...
    <input type="text" class="form-control" name="accomplie" id="formGroupExampleInput" placeholder="accomplie"required>
    ...
    <input type="text" class="form-control" name="observation" id="formGroupExampleInput" placeholder="observation"required>
  ...
  <div class="row">
     ...
     <textarea placeholder="description de la panne" name="description_panne"></textarea><br><br>
