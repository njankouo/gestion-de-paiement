...
<div class="col-md-9"><br><br><br><br>
  <div class="row">
           ...
           <div class="col-md-6">
           <form name="form" action="controller/intervenantController.php?action=create" method="POST" form="inline_group">
    
  

    <label for="nom">nom</label>
    <input type="text" class="form-control" name="nom" id="formGroupExampleInput" placeholder="entrez le nom"required> 
    ...
    <input type="text" class="form-control" name="prenom" id="formGroupExampleInput" placeholder="entrez le prenom"required>
    ...
    <input type="text" class="form-control" name="telephone" id="formGroupExampleInput" placeholder="entrez le numero de telephone"required>
  
     </div>  
      <div class="col-md-6"> <br>
      <label for="type">type intervention</label>

    <input type="text" class="form-control" name="type_intervention" id="formGroupExampleInput" placeholder="entrez le type d'intervention"required>
