    ...
    <a href="parc.php">liste des fournisseurs</a>
	   ...
	   <table id="tab" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    <th class="th-sm">#<span class="glyphicon glyphicon-sort-by-attributes-alt"></span>
                      ...
                      <th class="th-sm">nom du logiciel&nbsp;<span class="glyphicon glyphicon-sort"></span>
                       </th>
                        <th class="th-sm">type du logiciel&nbsp;<span class="glyphicon glyphicon-sort"></span>
                         </th>
                          
                        <th class="th-sm">version du logiciel&nbsp;<span class="glyphicon glyphicon-sort"></span>
                         </th>
                        <th class="th-sm">licence&nbsp;<span class="glyphicon glyphicon-sort"></span>
                         </th>
                        <th class="th-sm">date fin licence&nbsp;<span class="glyphicon glyphicon-sort"></span>
                         </th>
		...
		<?php
			...
			?>
			<tr class="element">
				<td class="data"><?php echo $logiciel->id ?></td>
				<td class="data"><?php echo $logiciel->nom?></td>
				<td class="data"><?php echo $logiciel->type ?></td>
				<td class="data"><?php echo $logiciel->version ?></td>
				<td class="data"><?php echo $logiciel->licence ?></td>
				<td class="data"><?php echo $logiciel->date_fin_licence ?></td>
				

				<td>
					<a href="<?php echo 'controller/logicielController.php?action=read&id=' . $logiciel->id ?>">
	  <button type="button" class="btn btn-success bt"name="modifier">modifier</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

					</a>
				
					<a href="<?php echo 'controller/logicielController.php?action=delete&id=' . $logiciel->id ?>">
